...
const Melting = () => {
  return (
    <div className="bg-gray-50 min-h-screen text-gray-800 ">
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 ml-90">
        <div className="bg-white shadow-lg rounded-xl p-8">
          ...
          <div className="space-y-4 text-base leading-relaxed">
            <div className="border-l-4 border-green-400 pl-4">
              <strong>1. Raw Material Handling:</strong> Sorts and loads scrap
              metals, alloys, and additives into furnaces.
            </div>
            <div className="border-l-4 border-green-400 pl-4">
              <strong>2. Melting Operations:</strong> Operates induction or
              electric arc furnaces to melt metal at controlled temperatures.
            </div>
            <div className="border-l-4 border-green-400 pl-4">
              <strong>3. Quality Checks:</strong> Performs chemical and
              temperature analysis to ensure composition meets specifications.
            </div>
            <div className="border-l-4 border-green-400 pl-4">
              <strong>4. Pouring & Casting:</strong> Transfers molten metal into
              molds for solidification and initial shaping.
            </div>
          </div>
        </div>
...
<div className='ml-30'>
      <div className="max-w-md mx-150 bg-white shadow-lg rounded-xl p-6 mt-8">
